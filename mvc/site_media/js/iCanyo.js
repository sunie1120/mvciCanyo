...
function carga_resultados_modificar(){
...
var nick_usuario = $("input[name='nick_usuario']").prop("value");
	 ...
	 var request =  $.ajax({
	 url: "../site_media/php/usuarios_modificar.php",
	 type: "POST",
...
* Funcion que recoge del DOM los valores de los inputs donde el usuario ha escrito los datos y genera una venana emergente que incluye un formulario con inputs de nuevo para poder
...
function carga_resultados_eliminar(){
...
var nick_usuario = $("input[name='nick_usuario']").prop("value");
	 ...
	 var request = $.ajax({
	 url: "../site_media/php/eliminar_usuario.php",
	 type: "POST",
	 data: 'nombre='+nombre+'&primer_apellido='+primer_apellido+'&segundo_apellido='+segundo_apellido+'&nick_usuario='+nick_usuario+'&id_usuario='+id_usuario,
	 dataType: "html"
	 });
